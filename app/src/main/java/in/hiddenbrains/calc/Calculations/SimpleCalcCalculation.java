...
public class SimpleCalcCalculation {
    ...
    public static String Solution(String StringToCalculate){
        ...
        if(stringBuffer.charAt(stringBuffer.length()-1) == '+' || stringBuffer.charAt(stringBuffer.length()-1) == '-' || stringBuffer.charAt(stringBuffer.length()-1) == '*' || stringBuffer.charAt(stringBuffer.length()-1) == '/' || stringBuffer.charAt(stringBuffer.length()-1) == '.' ){
        ...
        for(int i=0 ; i<stringBuffer.length();i++){
            if(stringBuffer.charAt(i) == '+' || stringBuffer.charAt(i) == '-' || stringBuffer.charAt(i) == '*' || stringBuffer.charAt(i) == '/'){
                if(stringBuffer.charAt(i+1) == '+' || stringBuffer.charAt(i+1) == '-' || stringBuffer.charAt(i+1) == '*' || stringBuffer.charAt(i+1) == '/'){
